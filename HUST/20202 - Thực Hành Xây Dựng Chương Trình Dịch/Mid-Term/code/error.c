...
struct ErrorMessage errors[NUM_OF_ERRORS] = {
  ...
  {ERR_VALUE_UNPACK1, "Too many values to unpack."}, // (2)
  {ERR_VALUE_UNPACK2, "Not enough values to unpack."}, // (2)
  {ERR_ASSIGN_VALUE_LITERAL, "Cannot assign to literal."}, // (2)
  {ERR_CONVERT_DOUBLE_INT, "Cannot convert double to int."} // (2)
};
