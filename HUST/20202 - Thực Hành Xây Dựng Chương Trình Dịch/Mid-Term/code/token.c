...
char *tokenToString(TokenType tokenType) {
  ...
  case TK_DOUBLE: return "a double number"; // (1)
  case TK_STRING: return "a string";        // (1)
  ...
  case KW_DOUBLE: return "keyword DOUBLE"; // (1)
  case KW_STRING: return "keyword STRING"; // (1)
