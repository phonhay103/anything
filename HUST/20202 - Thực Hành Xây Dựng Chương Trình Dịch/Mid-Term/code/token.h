...
#define KEYWORDS_COUNT 22 // (1)

typedef enum {
  TK_NONE, TK_IDENT, TK_NUMBER, TK_DOUBLE, TK_STRING, TK_EOF, TK_CHAR, // (1)

  KW_PROGRAM, KW_CONST, KW_TYPE, KW_VAR,
  KW_INTEGER, KW_CHAR, KW_DOUBLE, KW_STRING, // (1)
  KW_ARRAY, KW_OF, 
  ...
  SB_OPEN_BRACKET, SB_CLOSE_BRACKET, SB_MODULUS
} TokenType;
